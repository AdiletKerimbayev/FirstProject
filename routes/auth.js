...
router.post('/register', async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            from: '"Portfo" <adiletkerimbayev@yandex.com>',
            to: email,
            subject: 'Portfo - Confirm Your Email',
            text: `Welcome to Portfo, ${firstName}!\n\nYour confirmation code is: ${confirmationCode}\n\nPlease enter this code to confirm your account.`,
        };
...
router.get('/signin', (req, res) => {
    res.render(__dirname + '/../public/signin.ejs');
});
...
router.post('/signin', async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            from: '"Portfo" <adiletkerimbayev@yandex.com>',
            to: user.email,
            subject: 'Portfo - Login Notification',
            text: `Hello ${user.firstName},\n\nA new login to your Portfo account was detected. If this wasn't you, please contact support immediately.`,
        };
